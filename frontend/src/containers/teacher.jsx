...
import { coursePOST } from "../actions/courseAction";
...
const Teacher = () => {
      ...
      <tr className="tr" key={el._id}>
        ...
        <td className="td">
          <div>
            <button
              title="Edit"
              className="button__tableAction"
              onClick={() => updateTeacher(el, false, true)}
            >
              <img
                src="./edit.png"
                alt="Edit Icon"
                className="table__action--icons"
              />
            </button>
            <button
              title="Delete"
              className="button__tableAction"
              onClick={() => deleteTeacher(el, false, true)}
            >
              <img
                src="./delete.png"
                alt="Delete Icon"
  ...
  const onFieldsChange = (fieldName, e) => {
    if (fieldName === "salaryType" || fieldName === "city")
      ...
      if (extension === "jpg" || extension === "png") {
        ...
        else checkValidation(false, true, "file size is larger than 2MB"); //console.log('file size is larger than 2MB');
      } else checkValidation(false, true, "This file is not supported"); //console.log('this file is not supported.')
    } else
      setTeacherObj((prevState) => ({
        ...prevState,
  ...
  const onHandleSubmit = async (e) => {
    ...
    if (checkValidation(true, false, "Please fill all required fields.")) {
  ...
  return (
    <div className="teacher">
      {showUpdatePopup && (
        <UpdatePopup update={updateTeacher} obj={updateTeacherObj} />
      )}
      {deletePopup && (
        <DeletePopup delete={deleteTeacher} obj={deleteTeacherObj} />
      )}
      {showErrorPopup && (
      ...
      <div className="teacher__entry">
        ...
        <form
          ...
          className="teacher__entry--colContainer"
        >
          ...
          <div className="teacher__col">
            ...
            <div>
              <label className="button button__upload">
                ...
                <input
                  type="file"
                  onChange={(e) => onFieldsChange("img", e)}
          ...
          <div className="teacher__col">
            ...
            <div>
              ...
              <Select
                ...
                className="selectFields"
                onChange={(e) => onFieldsChange("salaryType", e)}
              />
            </div>
            <div>
